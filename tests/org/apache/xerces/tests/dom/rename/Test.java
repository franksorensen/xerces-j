...
package org.apache.xerces.tests.dom.rename;

import org.apache.xerces.samples.dom.ParserWrapper;
import org.apache.xerces.tests.dom.util.Assertion;
...
public class Test implements UserDataHandler {
    ...
    public static void main(String argv[]) {
        ...
        for (int i = 0; i < argv.length; i++) {
            ...
            if (parser instanceof org.apache.xerces.samples.dom.wrappers.Xerces) {
                try {
